...
<section class="section-padding bg-dark inner-header">
    ...
    <p class="mb-0 text-white"><a class="text-white" href="{{route('index')}}">Home</a> / <span class="text-success">About Us</span></p>
    </div>
    </div>
    </div>
    </div>
...
<section class="section-padding bg-white">
    ...
    <img class="img-fluid mb-4" src="{{asset('public/front/img/user/3.jpg')}}" alt="">
    ...
    <div class="col-lg-4 col-md-4">
    <div class="team-card text-center">
    <img class="img-fluid mb-4" src="{{asset('public/front/img/user/4.png')}}" alt="">
    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
